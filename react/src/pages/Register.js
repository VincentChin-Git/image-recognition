    ...
    return (
        <div className="sign-in-form-container">
            ...
            <div className="sign-in-form">
                ...
                <input className="form-input" value={state.password} onChange={e => handleInputChange(setState, 'password', e.target.value)} type="password" id="password" required />

                <label className="form-label" htmlFor="password">
                    Confirm Password
                </label>
                <input className="form-input" value={state.confirmPassword} onChange={e => handleInputChange(setState, 'confirmPassword', e.target.value)} type="password" id="confirm_password" required />
